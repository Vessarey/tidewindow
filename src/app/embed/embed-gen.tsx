...
export default function EmbedGenerator({ stations }: { stations: StationOption[] }) {
  ...
  const src = slug ? `${siteConfig.url}${siteConfig.basePath}/embed-badge/${slug}.html` : null;
  const snippet = src
    ...
    <div>
      ...
      {src && snippet && (
        <>
          ...
          <iframe src={`${siteConfig.basePath}/embed-badge/${slug}.html`} title="Tidewindow badge preview" width={320} height={86} style={{ border: 0, borderRadius: 8 }} />
