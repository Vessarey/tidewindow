...
export const metadata: Metadata = {
  ...
  description:
    "Put a live low-tide badge on your site — the best window in the next 30 days, updated daily from NOAA predictions, free, one copy-paste iframe.",
  ...
  return (
    <div>
      ...
      <p className="mt-3 max-w-2xl text-ink-soft">
        ...
        beach&apos;s best low-tide window in the next 30 days, refreshed every day from NOAA predictions. Free forever; the small
