---
title: "How Low Does the Tide Need to Be for Tide Pools? Testing the −0.5 ft Rule"
description: "The '−0.5 ft or lower' rule for tide pools is a Southern California number. We test it against 2026 NOAA data at Seattle, La Jolla, and Bar Harbor."
date: "2026-07-02"
category: "tide-basics"
tags: ["tide pools", "minus tide", "MLLW", "tide thresholds"]
faq:
  - q: "How low does the tide need to be for tide pools?"
    a: "There is no universal number. In Southern California, −0.5 ft MLLW is a genuinely good day — La Jolla's deepest daylight low in all of 2026 is −1.88 ft. On Puget Sound, hold out for −2.0 ft or lower; Seattle reaches −3.8 ft on July 14, 2026. At Bar Harbor, Maine, ordinary lows near 0.0 ft already work, and the year's deepest daylight low is −1.65 ft."
  - q: "What does a tide height of −0.5 ft mean?"
    a: "US tide predictions are measured against MLLW, the average of each day's lower low tide at that station over a 19-year epoch. A −0.5 ft prediction means the water drops half a foot below that local average — a different rarity everywhere. It's 27% of the way to La Jolla's 2026 daylight floor (−1.88 ft) but only 13% of the way to Seattle's (−3.80 ft)."
  - q: "Is a 0.0 ft tide low enough for tide pooling?"
    a: "Sometimes. A 0.0 ft low is by definition about average for a day's lowest water. At semidiurnal, big-range stations like Bar Harbor, ME (NOAA 8413320) it works: July 2026 has 24 daylight windows there and only 9 are minus tides. At Seattle (9447130), summer offers far better — 18 daylight minus tides in July 2026 alone, reaching −3.8 ft."
  - q: "How many minus tides happen in daylight in 2026?"
    a: "Across the 11 US West Coast stations Tidewindow tracks, 2026 has 940 minus tides, of which 535 (57%) fall at least partly in daylight. Bar Harbor, Maine, our East Coast station, gets 90 minus tides, with 52 of them (58%) touching daylight."
sources:
  ...
  - "https://www.nps.gov/acad/learn/nature/tides.htm"
...
Not by scanning tide tables for a magic number. The [Tide Window Finder](/tools/tide-window-finder/) computes the hours when a low tide overlaps daylight at any station we track, and stamps each window with an arrive-by time set one hour before the predicted low. The [daylight minus-tide index](/data/daylight-minus-tide-index/) shows the scale of the daylight problem: across our 11 West Coast stations, 2026 holds 940 minus tides, and only 535 of them — 57% — touch daylight. Bar Harbor's tally is 90, with 52 (58%) in daylight. Every formula behind these numbers is on the [methodology page](/methodology/).
