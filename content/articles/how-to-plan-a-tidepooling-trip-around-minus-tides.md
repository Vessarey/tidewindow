...
US tide heights are measured against MLLW — Mean Lower Low Water, the long-run average of each day's lowest tide. A **minus tide** is any low predicted below 0.0 ft on that scale: lower than a typical day's lowest water, exposing rock and reef that stay submerged the rest of the month. The full definition, and why minus tides cluster around new and full moons, is in [What Is a Minus Tide?](/guides/what-is-a-minus-tide/)

The catch is daylight. Minus tides are indifferent to your headlamp situation: of the 940 minus tides predicted at our West Coast stations in 2026, only 535 overlap daylight. Our lone East Coast station so far, [Bar Harbor, Maine](/beaches/me/bar-harbor-me/), gets 90 minus tides and 52 daylight ones, a similar 58 percent. The whole business of this site, tallied station by station in the [Daylight Minus-Tide Index](/data/daylight-minus-tide-index/), is finding the lows you can actually see.
...
Two working rules, both tested against a year of NOAA predictions in [the −0.5 ft rule article](/guides/how-low-does-the-tide-need-to-be-for-tide-pools/):
...
**The score** (0–100) blends depth below threshold, daylight overlap, and a weekend bonus, banded from Skip to Exceptional. The formulas are public on the [methodology page](/methodology/). If you're still translating raw tide tables by hand, [How to Read a Tide Table](/guides/how-to-read-a-tide-table/) covers what the charts don't say out loud.
...
Bar Harbor's 90 minus tides (52 in daylight) obey a different geometry than the Pacific's, and the walkable threshold sits lower. Start with [Why East Coast Tide Pooling Is Different](/guides/east-coast-tide-pooling-different/), then the [Acadia National Park windows guide](/guides/acadia-tide-pools-bar-island-ship-harbor/) for Bar Island and Ship Harbor timing.

## Why do the deepest tides dodge the weekend?

Because orbital mechanics doesn't take meetings. Summer's deepest Pacific lows land near dawn on whatever weekday the moon dictates (the mechanism is in [Why Summer's Lowest Tides Happen at Dawn on the Pacific Coast](/guides/why-summer-lowest-tides-happen-at-dawn-pacific/)), and in 2026 the dice came up cruel. Take the four deepest daylight windows at each of the ten regional stations above (every tracked West Coast station except La Push): 40 windows. **Only 5 fall on a weekend or holiday, and three of those are Christmas Day.**
...
The hour-of-day pattern is just as lopsided as the day-of-week pattern. Across all 535 daylight minus tides on the 2026 West Coast, the most common hour for the low is 6 AM (56 of them), and 312 of the 535 (58 percent) hit before 1 PM. The afternoon consolation peak, 51 lows in the 5 PM hour, belongs to fall and winter. Set the alarm; that's the price of admission. (Computed 2026-07-03 from NOAA predictions across the eleven West Coast stations.) And when the November–January perigean cycle produces the extreme highs *and* the rare daylight extreme lows, the dates are on the [king tides 2026–27 page](/guides/king-tides-2026-2027-dates/).

## Which tool does what?

All four [tools](/tools/) run on the same NOAA predictions and the same scoring:

- **[Tide Window Finder](/tools/tide-window-finder/)** — the daily driver. Pick a station, get the next 30 days of daylight windows, ranked, each with the arrive-by time. If you use one thing on this site, use this.
- **[Trip Picker](/tools/trip-picker/)** — for fixed dates. Give it your vacation week and a beach; it returns the single best hour in that range, even when the honest answer is "Thursday, 6:12 AM, and it's only a Fair."
- **[Year Heatmap](/tools/year-heatmap/)** — for choosing the dates in the first place. All 365 days at a station, colored by window quality. The July 13–16 band glows at every Northwest station; at La Jolla the glow sits in December. Book travel from this view, then confirm with the Finder.
- **[Golden Hour](/tools/golden-hour/)** — for photographers. It finds lows that overlap golden-hour light, with the sun's bearing at the moment of the low. Winter afternoon lows like La Jolla's 4:33 PM on December 25 are exactly the overlap it hunts; the year's 20 best are written up in [Golden Hour at Low Tide](/guides/golden-hour-low-tide-photography-calendar-2026/).

Beachcombers get their own timing logic (minus tides plus winter swell) in [Best Time for Sea Glass Hunting](/guides/best-time-sea-glass-hunting/).
...
- **Timing:** "Plan to arrive at the beach trailhead at least 30 minutes before the lowest tide." — NPS, [Tidepooling on the Olympic Coast](https://www.nps.gov/thingstodo/tidepooling-on-the-olympic-coast.htm)
...
That's the whole method. The moon publishes its schedule years in advance; NOAA turns it into numbers; we turn the numbers into hours. If you'd rather have the hours come to you, the [Minus Tide Alert](/newsletter/) sends one email a week with your coast's next windows — computed, never padded.
