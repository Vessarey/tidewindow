...
faq:
  - q: "What is a minus tide?"
    a: "A minus tide is a low tide with a predicted height below 0.0 ft on the MLLW datum — lower than the average of the lowest tide of each day measured over a 19-year epoch. Negative heights expose seafloor that most low tides never uncover."
  - q: "How often do minus tides happen?"
    a: "In clusters around new and full moons (spring tides), typically a handful of days per month. In bulk they are common: NOAA predictions give the 11 US West Coast stations Tidewindow tracks 940 minus tides in 2026, about 85 per station. Whether they land in daylight is the real filter — 535 of those 940 (57%) do."
  - q: "What does MLLW mean?"
    a: "Mean Lower Low Water — the average height of each day's lower low tide at a station, computed over the National Tidal Datum Epoch (currently 1983–2001). It's the zero point that US tide predictions and nautical charts use for depths."
  - q: "What share of minus tides happen in daylight?"
