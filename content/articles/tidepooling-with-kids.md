---
title: "Tidepooling With Kids: The Checklist, the Rules, and 2026's Best Weekend Windows"
description: "How to pick a kid-friendly tide window, what to pack, and the best 2026 weekend low tides for families in Washington, Oregon, and California."
date: "2026-07-03"
category: "families"
tags: ["tide pooling with kids", "family beach trips", "weekend tide windows", "tidepool etiquette", "low tide"]
faq:
  - q: "What is the best weekend tide window for kids on Puget Sound in 2026?"
    a: "Sunday, July 12, 2026: a −3.2 ft low at 9:40 AM at Seattle, NOAA station 9447130, with a working window from 7:15 AM to 12:10 PM and a score of 100. Port Townsend (station 9444900) has a −3.1 ft low at 8:47 AM the same morning, also scoring 100. The Saturday before, July 11, scores 100 at both stations too."
  - q: "When should families tidepool in Southern California in 2026?"
    a: "Skip summer — La Jolla's best July 2026 window is a −1.5 ft low at 4:54 AM, which means arriving around 3:54 AM. The family windows come with the holidays: Thanksgiving Day, November 26 (−1.4 ft at 4:46 PM, score 82) and Christmas Day, December 25 (−1.7 ft at 4:33 PM, score 90) at La Jolla, NOAA station 9410230."
  - q: "How early should you arrive before low tide with kids?"
    a: "About an hour before the predicted low — every Tidewindow window lists an arrive-by time computed exactly one hour ahead. For the July 12, 2026 Seattle low at 9:40 AM, that means arriving by 8:40 AM. Olympic National Park's guidance is to reach the beach trailhead at least 30 minutes before the lowest tide."
  - q: "What tidepool rules should kids know?"
    a: "From the National Park Service at Cabrillo National Monument: touch animals only as gently as you would touch your own eyeball; collect nothing, living or dead, including shells and rocks; never force an attached animal off its spot; and leave buckets, nets, and prying tools at home. Keep small children close on the rocks."
  - q: "Does Oregon have good weekend tide windows in 2026?"
    a: "Not many. Oregon's deep July 2026 lows land midweek — Newport (NOAA station 9435380) bottoms out at −2.5 ft on Tuesday, July 14 and Wednesday, July 15. The tied-best weekend window in the July–December fact set is Sunday, October 25, scoring 56 (Fair) at both Newport and Port Orford; Newport's low is deeper, −0.8 ft at 6:37 PM. A summer weekday off is the stronger Oregon play."
sources:
  - "https://www.nps.gov/thingstodo/visit-the-cabrillo-tidepools.htm"
  - "https://www.nps.gov/thingstodo/tidepooling-on-the-olympic-coast.htm"
...
1. **A weekend or holiday.** Obvious, and the binding constraint — it eliminates most of the calendar before you look at a single height.
2. **A mid-to-late-morning low.** Everyone is fed, sunblocked, and hours from naptime, and the whole window sits in full daylight.
3. **A long window.** Kids move at anemone speed. The July 12 Seattle window runs 295 minutes; you'll use them.
4. **A genuinely low low.** Below 0.0 ft MLLW at minimum; below −1 ft is where the good exposure starts.

The scoring on this site already weighs all four, which is why the ranking sometimes disagrees with the raw tide table. Seattle's deepest low of the season is −3.8 ft at 11:20 AM on Tuesday, July 14 — a spectacular tide that scores 90. Two days earlier, Sunday, July 12 is about six-tenths of a foot shallower at −3.2 ft, and scores 100. The Sunday wins because it's a Sunday. That is exactly the trade a family should make, and the [trip picker](/tidewindow/tools/trip-picker/) makes it automatically; the [methodology page](/tidewindow/methodology/) shows the arithmetic.
...
**Puget Sound is the family jackpot.** The July 11–12 weekend scores 100 four separate times across the two stations: Saturday brings −2.3 ft at 8:49 AM to Seattle and −2.4 ft at 7:58 AM to Port Townsend, then Sunday goes deeper still. If one kid melts down Saturday, Sunday is a full do-over. Seattle logs 18 daylight minus tides in July 2026 alone — the [Seattle station guide](/tidewindow/beaches/wa/seattle-wa/) lists every one. Sunday, August 9 offers an encore: −1.9 ft at Seattle (score 98) and −2.0 ft at Port Townsend (score 100). Of the 10 weekend-or-holiday windows scoring 80+ in the whole fact set, 7 are in Washington.

**Oregon runs midweek in 2026.** [Newport](/tidewindow/beaches/or/newport-or/) bottoms out at −2.5 ft on both Tuesday, July 14 (7:04 AM) and Wednesday, July 15 (7:50 AM) — exceptional tides on workdays. School's out in July; if a parent can take one too, that's the play. The lone weekend entry, Sunday, October 25 at 6:37 PM, is a Fair-band window that ends at dusk. Zero Oregon weekend windows in the fact set score 80 or better.

**California splits by season.** Summer weekend lows up north are shallow and early — Monterey's Saturday, August 1 low is 0.0 ft at 7:04 AM, score 57. Pillar Point's Sunday, October 25 afternoon (−0.5 ft, score 68) is the best northern weekend before the holidays, and Monterey tops it on Christmas Day with a −1.7 ft low at 5:53 PM, score 79. The south gets paid at the holidays: [La Jolla](/tidewindow/beaches/ca/la-jolla-ca/) has a −1.4 ft low on Thanksgiving afternoon and a −1.7 ft low at 4:33 PM on Christmas Day, the only Exceptional-band weekend-or-holiday window in the California sheet. San Diego's Cabrillo station (9410170) shows −1.7 ft at 4:36 PM that same Christmas afternoon, score 89.
...
The [Tide Window Finder](/tidewindow/tools/tide-window-finder/) lists the arrive-by time for every upcoming window at all twelve stations. July 12 is a Sunday and it scores 100. Pack the bag the night before.
