...
description: "Every top golden-hour low-tide overlap for La Push, Garibaldi, Monterey, and La Jolla in 2026, with sun bearings and scores from NOAA predictions."
date: "2026-07-03"
category: "photography"
tags: ["low tide photography", "golden hour", "sun azimuth", "minus tide", "west coast"]
faq:
  - q: "When is the best golden-hour low tide of 2026 on the West Coast?"
    a: "In Tidewindow's next-120-day rankings (computed 2026-07-03), Sunday, July 12, 2026 at La Push, WA — NOAA station 9442396 — tops the list: a −2.1 ft low at 5:35 AM, 3 minutes after sunrise, scoring 97 of 100. Garibaldi's best follows on July 13 (−2.1 ft at 6:34 AM) and Monterey's on July 15 (−1.6 ft at 6:14 AM)."
  - q: "What does sun azimuth mean in beach photography?"
    a: "Azimuth is the sun's compass bearing, measured clockwise from true north: 0° is north, 90° east, 180° south, 270° west. Every window in this 2026 calendar puts the sun between 45° and 72° — northeast to east-northeast — so on a west-facing Pacific beach the light comes from behind you, front-lighting sea stacks and wet sand."
  - q: "Are golden-hour low tides also minus tides?"
    a: "Usually, at least in the top ranks: 22 of the 24 windows in this 2026 calendar sit below 0.0 ft MLLW. The deepest is −2.7 ft at La Push (NOAA station 9442396) at 6:26 AM on July 13, 53 minutes after sunrise. The two exceptions — +0.25 ft at Garibaldi on July 25 and +0.06 ft at La Jolla on July 4 — made their stations' top-6 lists on light alone."
  - q: "Why do all the top 2026 golden-hour overlaps land on July mornings?"
    a: "The daily low arrives roughly 30–60 minutes later each day while sunrise barely moves, so each spring-tide run crosses sunrise on only one or two mornings. In summer 2026 the deep lows pass through dawn in July: all 24 top-ranked overlaps at the four stations fall between July 3 and July 29, computed 2026-07-03 over the next 120 days of NOAA predictions."
  - q: "How early should I arrive for a golden-hour low-tide shoot?"
    a: "About an hour before the predicted low — for La Push's July 12, 2026 window that means 4:35 AM for the 5:35 AM low — and earlier if you want blue hour, since that window opens at 3:00 AM. Olympic National Park advises: 'Always carry a tide table, topographic map, and keep track of the time whenever hiking along Olympic's coast.'"
sources:
