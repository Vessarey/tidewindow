...
faq:
  - q: "Is Rialto Beach and Hole-in-the-Wall open in summer 2026?"
    a: "No. Olympic National Park has closed Mora Road beyond Mora Campground from July 8 to October 15, 2026 for construction, and the park states Rialto Beach 'will not be accessible via Mora Road during this construction period.' That covers the entire July 12–17 minus-tide run. For tidepools on the same tides, use Second Beach, reached by a 0.7-mile trail off La Push Road."
  - q: "When is the best tidepooling at La Push in 2026?"
    a: "The run of July 12–17, 2026 holds the year's best daylight lows, computed from NOAA La Push station 9442396. The deepest is −3.00 ft MLLW on Tuesday, July 14 at 7:15 AM — the lowest daylight tide of the year here. For a weekend, Sunday, July 12 scores highest at 97 (−2.14 ft at 5:35 AM); Saturday the 11th rates only Good because its low lands before sunrise."
  ...
  - q: "How deep does the tide get at La Push in July 2026?"
    a: "At NOAA station 9442396, the July 12–17 run runs Exceptional every day: −2.14 ft (Sun 12), −2.70 ft (Mon 13), −3.00 ft (Tue 14), −2.98 ft (Wed 15), −2.63 ft (Thu 16), and −2.00 ft (Fri 17). Tuesday, July 14 at −3.00 ft is the deepest daylight low of the year. August's best run peaks August 12 at −2.31 ft."
sources:
  - "https://tidesandcurrents.noaa.gov/stationhome.html?id=9442396"
  - "https://www.nps.gov/olym/planyourvisit/conditions.htm"
  - "https://www.nps.gov/olym/planyourvisit/visiting-mora-and-rialto.htm"
...
Tidewindow computes windows for the La Push beaches from the nearest NOAA prediction station, [La Push, Quillayute River (9442396)](/beaches/wa/la-push-wa/). Here are the eight deepest daylight lows of the year, ranked by depth, with the score that folds tide depth and daylight together.
...
Notice the scores. Tuesday the 14th is the deepest at −3.00 ft but scores 90, while Sunday the 12th, a foot shallower, scores 97. Depth is only half the story; the window scale also weighs how much of the low falls in usable daylight and how workable the hour is. The [methodology page](/methodology/) shows exactly how the two combine. The short version for planning: the 14th gives you the most exposed rock, and the 12th gives you the friendliest morning.
...
Watch the low time march down the column: 5:35 AM on Sunday, past 9:00 AM by Friday. Early in the run you trade a pre-dawn start for the deepest water; later, the low drifts into comfortable mid-morning. If your calendar only bends on weekends, **Sunday, July 12** is the pick — its low at 5:35 AM catches first light and it scores the run's highest 97. Saturday the 11th does *not* make the table: its low falls at 4:39 AM, before sunrise, so it rates only Good (74) despite a respectable −1.37 ft. The sun is the constraint here, not the water. This same new-moon run pulls the tide back all along the coast; the [West Coast minus-tide roundup](/guides/west-coast-minus-tides-july-11-14-2026/) lines La Push up against Puget Sound, the Oregon coast, and California the same week, and the nearest inland-water sibling guide, [Port Townsend](/guides/port-townsend-fort-worden-tide-pools-2026/), runs its own Exceptional stretch on these dates.
...
For the day-by-day picture, the [year heatmap](/tools/year-heatmap/) shows just how alone this week stands on the 2026 La Push calendar, and the [trip picker](/tools/trip-picker/) finds multi-day runs like this one without being asked. Chasing the light as much as the water? The [golden-hour calendar](/tools/golden-hour/) flags the mornings when the low and the low sun line up. And if you are wondering why every good summer low here comes at dawn, the [dawn-lows guide](/guides/why-summer-lowest-tides-happen-at-dawn-pacific/) unpacks it. Six mornings, one moon — just point the car down La Push Road, not Mora Road, this year.
