...
faq:
  ...
  - q: "Does a −1.0 ft tide mean the same thing in Maine and California?"
    a: "The datum logic is identical — 1 ft below the station's long-run average lowest daily tide — but the relative payoff differs. At Bar Harbor a −1.0 ft low adds about 9% to an 11.37 ft typical full drop; at La Jolla it adds about 19% to a 5.33 ft drop. In Maine ordinary lows already expose a huge zone; in SoCal, minus tides are the main event."
  - q: "Do East Coast minus tides happen in daylight?"
    a: "Yes. At Bar Harbor (station 8413320), 52 of the 90 minus tides in 2026 (58%) overlap daylight — almost identical to the 57% share across our 11 West Coast stations. The clock differs, though: Bar Harbor's most common daylight minus-tide hour in 2026 is 4 PM, while on the West Coast it's 6 AM."
sources:
  - "https://tidesandcurrents.noaa.gov/stationhome.html?id=8413320"
  - "https://tidesandcurrents.noaa.gov/stationhome.html?id=9410230"
  - "https://api.tidesandcurrents.noaa.gov/mdapi/prod/webapi/stations/8413320/datums.json?units=english"
...
Near-term, the [Bar Harbor July calendar](/beaches/me/bar-harbor-me/2026-07/) has back-to-back mornings on July 16 (−1.3 ft at 6:49 AM, score 76) and July 17 (−1.1 ft at 7:41 AM, score 77). If you need a weekend, Saturday August 15 brings −0.8 ft at 7:16 AM, score 75. The species lists differ as much as the tides: recent observations near [Bar Harbor](/beaches/me/bar-harbor-me/) run to periwinkles and tortoiseshell limpets (17 reports each), while [La Jolla's](/beaches/ca/la-jolla-ca/) recent list is wall-to-wall nudibranchs, led by 138 reports of the Sorcerer's Dorid.

One caution scales with the range: an 11 ft flood comes back fast. The National Park Service's tidepooling guidance for Acadia puts the usable window at "1.5 hours before to 1.5 hours after low tide" and advises that "it is best to start tidepooling before low tide and to leave as the tide is rising." They also note that "black rocks and seaweed are especially slippery." Treat the arrive-by times in the [Tide Window Finder](/tools/tide-window-finder/) as the start of your exit plan, not just your entrance.
