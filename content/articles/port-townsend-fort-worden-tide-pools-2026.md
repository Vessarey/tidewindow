...
faq:
  - q: "What is the best day for tide pooling in Port Townsend in 2026?"
    a: "The run of July 11–16, 2026 holds the year's best tide pooling, computed from NOAA Port Townsend station 9444900. The deepest daylight low is −3.48 ft MLLW on Tuesday, July 14 at 10:25 AM, matched almost exactly by Monday the 13th (−3.48 ft, 9:36 AM). For a weekend, both Saturday July 11 and Sunday July 12 score a flat 100 — the tide bottoms out around 8 to 9 AM, in easy morning light."
  - q: "What time should I arrive for low tide at Fort Worden?"
    a: "About an hour before the predicted low, and stay through it. For Sunday, July 12, 2026 (−3.10 ft low at 8:47 AM at NOAA station 9444900), that means arriving by roughly 7:47 AM; the usable window runs about 6:00 AM to 12:10 PM. Getting there early lets you follow the water out to the lowest rocks instead of chasing a tide that has already turned."
  - q: "Do you need a Discover Pass to park at Fort Worden State Park?"
    a: "Yes. Fort Worden is a Washington state park, and a Discover Pass is required for vehicle access — $10 for a one-day pass or $45 for the annual pass, per Washington State Parks. The park is in Port Townsend and holds North Beach, the Point Wilson shoreline, and the Port Townsend Marine Science Center."
  - q: "How many daylight minus tides does Port Townsend get in the second half of 2026?"
    a: "37 at NOAA station 9444900: 17 in July, 13 in August, 6 in September, 1 in October, and none in November or December. Puget Sound's tide-pool season is essentially summer — by late fall every low below +1 ft falls after dark, so the good water is gone until spring."
sources:
  - "https://tidesandcurrents.noaa.gov/stationhome.html?id=9444900"
  - "https://www.parks.wa.gov/find-parks/state-parks/fort-worden-historical-state-park"
...
Tidewindow computes windows for the Fort Worden beaches from the nearest NOAA prediction station, [Port Townsend (9444900)](/beaches/wa/port-townsend-wa/). Here are the eight deepest daylight lows of 2026, ranked by depth, with the score that folds tide depth and daylight together.
...
For the day-by-day picture through the year, the [Puget Sound low tide calendar](/guides/puget-sound-low-tide-calendar-2026/) has every window; the [trip picker](/tools/trip-picker/) finds the multi-day runs like this one, and the [year heatmap](/tools/year-heatmap/) shows just how alone mid-July stands on the Port Townsend calendar. Curious why the best summer lows all come in the morning? The [dawn-lows guide](/guides/why-summer-lowest-tides-happen-at-dawn-pacific/) unpacks it. Six mornings, one moon — set an early alarm.
